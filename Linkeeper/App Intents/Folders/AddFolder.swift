        ...
        if #available(iOS 16.4, *) {
            return ItemCollection {
                ItemSection("Objects",  items:
                                intentSymbolNames[0].keys.map {
                    IntentItem<String>.init(
                        $0,
                        title: LocalizedStringResource(stringLiteral: intentSymbolNames[0][$0]!),
                ...
                ItemSection("People",  items:
                                intentSymbolNames[1].keys.map {
                    IntentItem<String>.init(
                        $0,
                        title: LocalizedStringResource(stringLiteral: intentSymbolNames[1][$0]!),
                        subtitle: LocalizedStringResource(stringLiteral: $0),
                        image: .init(systemName: $0)
                    )
                }
                ...
                ItemSection("Symbols",  items:
                                intentSymbolNames[2].keys.map {
                    IntentItem<String>.init(
                        $0,
                        title: LocalizedStringResource(stringLiteral: intentSymbolNames[2][$0]!),
                        subtitle: LocalizedStringResource(stringLiteral: $0),
                        image: .init(systemName: $0)
                    )
                }
